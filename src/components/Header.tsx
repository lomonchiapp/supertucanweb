      ...
      >
        ...
        <div className="bg-neutral-950 text-neutral-300">
          <div className="max-w-[1400px] mx-auto px-8 h-9 flex items-center justify-between text-[11px]">
            ...
            <div className="flex items-center gap-5">
              <a
                href={`https://wa.me/18092468383?text=${encodeURIComponent(t('header.topbar.customerServiceMessage'))}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 hover:text-[var(--color-primary)] transition-colors tracking-wide"
              >
